...
import org.s4s0l.betelgeuse.akkacommons.{BetelgeuseAkkaService, BetelgeuseAkkaServiceId}
...
trait BetelgeuseAkkaClusteringClient extends BetelgeuseAkkaService {
  ...
  protected def clusteringClientCreateConfig(id: BetelgeuseAkkaServiceId): Config = {
