...
/**
  * @author Maciej Flak
  */
class BgPersistenceJournalRoachTest extends BgTestWithRoachDb[BgPersistenceJournalRoach with BgClusteringSharding] {
  ...
  feature("Journal is capable of supporting sharded actors") {
    ...
    scenario("sharded actor is persistent with passivation timeout and can be restored") {
      val sharding = BgClusteringShardingExtension(system)
...
object BgPersistenceJournalRoachTest {
